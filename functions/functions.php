<?php
    ...
    $con = mysqli_connect("localhost", "root", "SAdeveloperS", "ecommerce");
    ...
    function getCategoryProducts()
    {
        if (isset($_GET['cat'])) {
            ...
            $num_cat_pro = mysqli_num_rows($run_cat_pro);
            if ($num_cat_pro > 0) {
    ...
    function getBrandProducts()
    {
        if (isset($_GET['brand'])) {
            ...
            $num_brand_pro = mysqli_num_rows($run_brand_pro);
    ...
    function cart()
    {
        ...
        if (isset($_GET['add_cart'])) {
            ...
            if (mysqli_num_rows($run_check) > 0) {
                ...
                $insert_pro = "INSERT INTO cart (product_id,ip_add,quantity) VALUES ($pro_id,'$ip',1)";
